  ...
  <body>
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <img src="./images/website/40years.jpg" alt="trending images" class="img-responsive blog-image" style="width:100%">
        </div>
      </div>
