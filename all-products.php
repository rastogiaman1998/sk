 ...
 <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">        
            <center><img src="./images/website/products.jpg" alt="Banner" style="background-repeat: repeat-x"></center>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-3 col-m-6 col-6 productlink">
            <ul class="list-group">
                <?php
            ...
            while($row=$result->fetch_assoc()) {?>
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <div class="card" style="margin-top:2px; margin-bottom:10px; padding:20px;">
                        <div class="inner">
                            <img class="card-img-top product-image" src="./images/products/<?php echo $row['image'] ?>"  alt="Product Image">
                        </div>
                        <div class="card-body">
                             ...
                             <h5 class="card-title product-card-title"><?php echo $row['model_name']?></h5>
                              <?php 
                                    if($row['price'] >0) {
                                        ...
                                        echo "<p>Call us to get Best Price</p>";
                                    }
