...
<html lang="en">
  ...
  <body>
    ...
    <img class="blog-image" src="images/website/boy.jpg"alt="Banner Slide">
    ...
    <div class="container" style="padding-top:10px;">
      ...
      <div class="row">
        <div class="col-12">
          <p> We love to hear from our customers and partners. Reach out using any channel of your preference.</p>
          <hr />
        </div>
      </div>
    </div>
