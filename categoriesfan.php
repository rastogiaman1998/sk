      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-6 col-md-6">
               <div class="card">
                  <div class="inner">
                     <img class="card-img-top" src="./images/website/Capture1.png" alt="Ceiling Fan" style="height:25rem;">
                  </div>
                  <div class="card-body">
                     <?php 
                        require_once("./sections/heading.php");
                     ...
                     <center>
                        <a href="products.php?product_type=Ceiling%20fan" class="btn btn-outline-danger">View All Products</a>
                     </center>
                  </div>
               </div>
            </div>
            <div class="col-lg-6 col-md-6">
               <div class="card">
                  <div class="inner">
                     <img class="card-img-top" src="./images/website/ceiling_fans.PNG" alt="Ceiling Fan" style="height:25rem;">
                  </div>
                  <div class="card-body">
                     <?php 
                        require_once("./sections/heading.php");
                        getSectionHeading("Ceiling Fan");
                     ?>
                     <p class="card-text">
