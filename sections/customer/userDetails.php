...
?>
            ...
            <input type='hidden' name='user_id' id='user_id' class='form-control' value="<?php echo $row['user_id'];?>">
...
$user_id= isset($_POST['user_id']) ? $_POST['user_id'] : null;
  ...
  $sql1 = "UPDATE users SET first_name='$first_name', last_name='$last_name', email='$email', mobile_number='$mobile_number',address='$address', city='$city', state='$state' where user_id='$user_id'";
