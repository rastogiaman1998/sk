...
<?php
    ...
    if (isset($_REQUEST['mobile_number'])) {
      ...
      //  $user_id = 123;//get highest user_id form users table add 1 to it.we use max function
        $query    = "INSERT into `users` (first_name, last_name,usertype, password,mobile_number)
                     VALUES ('$first_name', '$last_name','Customer','$password','$mobile_number')";
...
?>
    ...
    <form class="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="tel" pattern= "[0-9]{10}" oninvalid="setCustomValidity('Please enter at 10 digit Mobile number')" class="login-input" name="mobile_number" placeholder="Mobile Number">
